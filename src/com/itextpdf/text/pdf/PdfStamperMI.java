...
public class PdfStamperMI
    ...
    protected PdfSignatureAppearanceMI sigApp;
    protected XmlSignatureAppearanceMI sigXmlApp;
    private LtvVerificationMI verification;
     ...
     */
    public PdfStamperMI(final PdfReader reader, final OutputStream os) throws DocumentException, IOException {
     ...
     * @throws IOException on error
     */
    public PdfStamperMI(final PdfReader reader, final OutputStream os, final char pdfVersion) throws DocumentException, IOException {
     ...
     * @throws IOException on error
     */
    public PdfStamperMI(final PdfReader reader, final OutputStream os, final char pdfVersion, final boolean append) throws DocumentException, IOException {
     ...
     */
    public PdfSignatureAppearanceMI getSignatureAppearance() {
        return sigApp;
    }
     ...
     */
    public XmlSignatureAppearanceMI getXmlSignatureAppearance() {
        return sigXmlApp;
    }
     ...
     * @throws IOException on error
     */
    public static PdfStamperMI createSignature(final PdfReader reader, final OutputStream os, final char pdfVersion, File tempFile, final boolean append) throws DocumentException, IOException {
        PdfStamperMI stp;
        if (tempFile == null) {
            ByteBuffer bout = new ByteBuffer();
            stp = new PdfStamperMI(reader, bout, pdfVersion, append);
            stp.sigApp = new PdfSignatureAppearanceMI(stp.stamper);
            ...
            stp = new PdfStamperMI(reader, fout, pdfVersion, append);
            stp.sigApp = new PdfSignatureAppearanceMI(stp.stamper);
     ...
     * @return a <CODE>PdfStamper</CODE>
     */
    public static PdfStamperMI createSignature(final PdfReader reader, final OutputStream os, final char pdfVersion) throws DocumentException, IOException {
     ...
     * @throws IOException on error
     */
    public static PdfStamperMI createSignature(final PdfReader reader, final OutputStream os, final char pdfVersion, final File tempFile) throws DocumentException, IOException {
        return createSignature(reader, os, pdfVersion, tempFile, false);
    }

    public static PdfStamperMI createXmlSignature(final PdfReader reader, final OutputStream os) throws IOException, DocumentException {
        PdfStamperMI stp = new PdfStamperMI(reader, os);
        stp.sigXmlApp = new XmlSignatureAppearanceMI(stp.stamper);
        //stp.sigApp.setSigout(bout);
        //stp.sigApp.setOriginalout(os);
    ...
    public LtvVerificationMI getLtvVerification() {
        if (verification == null)
            verification = new LtvVerificationMI(this);
        return verification;
    }
