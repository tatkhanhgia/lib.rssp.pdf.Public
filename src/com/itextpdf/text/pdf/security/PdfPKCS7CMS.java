...
public class PdfPKCS7CMS {
     ...
     */
    public PdfPKCS7CMS(PrivateKey privKey, Certificate[] certChain,
...
//        }
    ...
    public PdfPKCS7CMS(byte[] contentsKey, byte[] certsKey, String provider) {
        try {
            this.provider = provider;
     ...
     */
    @SuppressWarnings({"unchecked"})
    public PdfPKCS7CMS(byte[] contentsKey, PdfName filterSubtype, String provider) {
