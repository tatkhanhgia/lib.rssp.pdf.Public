...
// */
//public class PdfPKCS7V4_BACKUP {
//
...
//     */
//    public PdfPKCS7V4_BACKUP(PrivateKey privKey, Certificate[] certChain, 
...
//	public PdfPKCS7V4_BACKUP(byte[] contentsKey, byte[] certsKey, String provider) {
//        try {
//            this.provider = provider;
...
//     */
//	@SuppressWarnings({ "unchecked" })
//	public PdfPKCS7V4_BACKUP(byte[] contentsKey, PdfName filterSubtype, String provider) {
