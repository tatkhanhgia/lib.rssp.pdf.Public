...
public class PdfPKCS7_CMS {
     ...
     */
    public PdfPKCS7_CMS(PrivateKey privKey, Certificate[] certChain,
...
//        }
    ...
    public PdfPKCS7_CMS(byte[] contentsKey, byte[] certsKey, String provider) {
        try {
            this.provider = provider;
     ...
     */
    @SuppressWarnings({"unchecked"})
    public PdfPKCS7_CMS(byte[] contentsKey, PdfName filterSubtype, String provider) {
