...
public class LtvTimestampMI {
     ...
     */
    public static void timestamp(PdfSignatureAppearanceMI sap, TSAClient tsa, String signatureName) throws IOException, DocumentException, GeneralSecurityException {
