 ...
 * @author Paulo Soares
 */
public class LtvVerificationMI {

    private Logger LOGGER = LoggerFactory.getLogger(LtvVerificationMI.class);

    private PdfStamperMI stp;
     ...
     */
    public LtvVerificationMI(PdfStamperMI stp) {
        this.stp = stp;
