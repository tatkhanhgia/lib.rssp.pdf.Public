...
//        }
        ...
        try {
            ...
            if (dsImage) {
                ...
                if (image != null) {
                    ...
                    par.setLeading(finalFontSize * lineSpacing);
    ...
    private boolean containsHTMLChars(String content) {
    ...
    private void processParagraph(Paragraph par, String textContent) {
